...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "61fc0c97-6ab9-4f9e-b548-21abf2e6455f"); // Replace with your Web3Forms access key
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">msshruti.ai@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">+91 9390235769</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="https://www.linkedin.com/in/shrutisingh7b32b222b" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-indigo-400 transition-colors">
                      Connect on LinkedIn
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="https://github.com/shrutigitam" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                      View GitHub Profile
                    </a>
                  </div>
                </div>
